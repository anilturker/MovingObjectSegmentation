...
from models.network_tools import conv_block_3d, conv_block, weight_init
...
class AvFeat_v4(nn.Module):
    ...
    def __init__(self, filter_size):
        ...
        self.convlstm_block = ConvLSTMBlock(1, 1, kernel_size=3, padding=1)
    ...
    def forward(self, inp):
        ...
        x = self.convlstm_block(inp)
        x1_1 = self.conv1_5x5(x)
        x1_2 = self.conv1_3x3(x)
        x1_3 = self.conv1_1x1(x)
